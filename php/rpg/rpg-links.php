...
<div class="section-clip rpg-links-clip" data-links="<?php echo $rpgLinksKind; ?>" aria-hidden="true">
	<a href="index.php" class="section-logo-bug white-bg repaint z-4" aria-label="Ethan Welner home">EW</a>
	<div class="section-about-social-container z-4">
		<a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ethan-welner-555b4055/" aria-label="LinkedIn">
			<div class="social-link white-bg repaint">
		...
		<button type="button" class="section-about-me white-text repaint about-me-link">About Me</button>
	</div>
<?php endif; ?>
