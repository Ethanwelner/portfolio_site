    ...
    <div class="d-flex flex-wrap flex-xs-nowrap">
      ...
      <div class="d-inline-flex flex-12 flex-gap-48 flex-wrap flex-md-nowrap">
        <div class="game-mechanics flex-6">
          ...
          <div class="copy mb-3">
            <p>Because Traits can take so many different forms, they are subdivided into seven categories. The categories listed below represent the fundamental basic categories of a Trait. The Traits category determines how it interacts with characters and the game's systems.</p>
        ...
        <div class="game-mechanics flex-6">
          ...
          <div class="d-flex flex-wrap flex-gap-12 mb-4">
            ...
            <div class="trait-box">
              ...
              <div class="badge bg-dark white-text d-inline-flex">(Memory 3)</div>
              <div class="copy">- This character has knowledge orc customs and can be assumed to be familiar with the institutions and traditions of Orc societies.</div>
            </div>
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This character has a knowledge of mathematics and of mathematical fields of study.</div>
            </div>
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This character has a knowledge of Elemental Magics, including the theoretical underpinnings of that magic as well as its history.</div>
            </div>
          ...
          <div class="d-flex flex-wrap flex-gap-12 mb-4">
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This character is capable of performing the basic tasks of maintaining a Long Sword without a skill check.</div>
          ...
          <div class="d-flex flex-wrap flex-gap-12 mb-4">
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This character can request advantage in any scenario where their mental facilities are being severely taxed, be it resisting the mesmerizing effects of a vampire or pushing through a long march without becoming exhausted.</div>
            </div>
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This character can request advantage in situations where the appearance of athleticism can effect the outcome of a roll or situation (useful for models, athletes with endorsements, or barbarians trying to intimidate)</div>
            </div>
          ...
          <div class="d-flex flex-wrap flex-gap-12 mb-4">
            ...
            <div class="trait-box">
              ...
              <div class="copy">Temporary (Lost when the characters innocence is proclaimed or they are caught)</div>
              <div class="d-inline-flex flex-gap-4">
                <div class="badge bg-dark white-text d-inline-flex">(None)</div>
              </div>
              <div class="copy">- This Character is wanted on all Terran planets for Past crimes.</div>
              <div class="copy">- This Characters wanted status is severe and law enforcement and bounty hunting entities are actively searching for them.</div>
            </div>
            ...
            <div class="trait-box">
              ...
              <div class="copy">- Due to recent events this Character is famous and can Request Advantage in Social situations where the Characters fame may aid them.</div>
            </div>
          ...
          <div class="d-flex flex-wrap flex-gap-12 mb-4">
            ...
            <div class="trait-box">
              ...
              <div class="copy">Temporary (This trait lasts a number of minutes equal to the casters Rank in this ability)</div>
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This character is dead and can not perform voluntary actions.</div>
              <div class="copy">- This character can not be healed by any means unless otherwise stated.</div>
            </div>
          ...
          <div class="d-flex flex-wrap flex-gap-12 mb-4">
            <div class="trait-box">
              ...
              <div class="copy">- This character has lost control over their body to supernatural entity. If this is a player character then how that player or the DM continue to operate the character is at DM discretion, as is the nature of the entity that has possessed them.</div>
          ...
          <div class="d-flex flex-wrap flex-gap-12 mb-4">
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This characters biology allows them to use their breath as a tool or weapon.</div>
            ...
            <div class="trait-box">
              ...
              <div class="copy">- Rank *3 added to this characters armor stat for attacks that hit its torso.</div>
            </div>
            ...
            <div class="trait-box">
              ...
              <div class="copy">- This character is capable of performing significant numbers of mathematical calculations simultaneously, it is DM discretion when and how this ability is limited.</div>
            </div>
