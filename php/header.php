<a href="index.php" class="logo-bug repaint z-4" aria-label="Ethan Welner home">EW</a>
...
<div class="section-about-social-container">
	...
	<!-- about me link -->
	<button type="button" class="section-about-me repaint about-me-link">About Me</button>
