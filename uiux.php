...
<html lang="en">
	...
	<body class="">
	  	...
	  	<!------------ UI UX red section ------------>
		<div class="section short-section red-bg d-flex red-section z-4">
				...
				<?php include 'php/header.php'; ?>
		  		...
		  		<div class="title section-title d-inline-flex z-2">
		  			<div class="hero-statement pre-slide-in">
			  			...
			  			<h1 class="title hero-title white-text">UI/UX</h1>
						<h2 class="title section-title white-text">User Interface and Experience</h2>
					    <h3 class="sub-title white-text non-title">The Mathematics of Design</h3>
		...
		<div class="section unlimited white-bg d-flex">
			<a href="index.php" class="section-logo-bug red-bg repaint z-3">EW</a>
			...
			<div class="container d-flex z-2 flex-wrap mt-5 mt-lg-0">
				...
				<div class="d-flex mb-5 flex-wrap flex-xs-nowrap">
				    ...
				    <div class="d-inline-flex align-items-center flex-12">
				    	<div class="text-center">
					    	<div class="copy stinger red  mb-3">Competitive Analysis, Goals, and Paper</div>
				...
				<div class="col-12 col-sm-8 p-0">
				    <div class="embed-responsive embed-responsive-16by9 shadow-diffuse">
				    	...
				    	<div class="load-proto red-bg" onClick='document.getElementById("ifr").src="https://xd.adobe.com/embed/258f7a49-3c3a-43f5-7e30-29541037c5f1-53be/";'>
				    		<div class="sub-title white-text text-center">Click or tap to load the prototype</div>
				    	</div>
				    </div>
				</div>
				<div class="col-2 d-none d-sm-flex">
