    ...
    <body>
        ...
        <div class="section unlimited white-bg d-flex">
            ...
            <div class="container d-flex z-2 flex-wrap mt-5 mt-lg-0 justify-content-center">
                    ...
                    <div class="d-flex flex-wrap flex-xs-nowrap">
                        ...
                        <div class="d-inline-flex flex-12 flex-gap-48">
                            <div class="game-mechanics flex-6">
                                ...
                                <p class="">Resistances are used to reduce incoming damage by a specified amount. Resistances begin at zero. Incoming damage will always have a type, and some forms of attacks will do multiple types of damage at once. A fiery explosion will do both blunt damage through the explosion itself, as well as heat damage through the heat of the fireball. Resistances are predominantly conveyed through equipment, but some Traits may provide additional resistances. A character's resistances are cumulative; if a character has both leather armor and scaly skin, their resistance to slashing will be higher than if they had either alone.<br><br>
                ...
                <div class="d-flex flex-fill flex-wrap flex-xs-nowrap mb-4 column-container">
                    <div class="flex-12 mb-4">
                        <h3 class="sub-title mb-3">Sample Character Sheet</h3>
                        <div class="copy stinger black mb-3">placeholder subtitle</div>
                    </div>
                    <div class="d-inline-flex flex-12 flex-gap-48">
                        <div class="game-mechanics flex-6">
                        ...
                        <div class="game-mechanics flex-6">
                            ...
                            <div>
                                ...
                                <div class="line-container">
                                    <h5><strong>Profession: Smuggler</strong></h5>
                                    <div class="line"></div>
                                </div>
                                <h6>Skill Feats</h6>
                                <p>Smooth Talker<br>
                                ...
                                <div class="line-container">
                                    <h5><strong>Past: Raised By The Streets</strong></h5>
                                    <div class="line"></div>
                                </div>
                                <h6>Skill Feats</h6>
                                <p>Schemer<br>
